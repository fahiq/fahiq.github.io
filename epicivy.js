    ...
    if (!isChatClosed) {
        ...
        if (chatBoxMinimizeElement && chatContentWindowElement) {
            chatBoxMinimizeElement.addEventListener('click', function () {
                ...
                chatContentWindowElement.classList.toggle('ei-chat-remove-class ei-live-chat-minimize');
            });
        }
    }
