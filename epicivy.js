...
var setupChat = function (isChatClosed) {
    ...
    var chatBoxMaximizeElement = document.getElementById('chatBoxMaximizeBtn');
    var chatLiveWindowElement = document.getElementById('live-chat');
    if (!isChatClosed) {
        document.body.appendChild(chatLogicScript);
        if (chatBoxMinimizeElement && chatContentWindowElement && chatLiveWindowElement) {
            chatBoxMinimizeElement.addEventListener('click', function () {
                ...
                chatLiveWindowElement.classList.toggle('ei-live-chat-minimize');
            });
        }
        // if (chatBoxMaximizeElement && chatLiveWindowElement) {
        //     chatBoxMaximizeElement.addEventListener('click', () => {
        //         let EI_cookie = getCookie();
        //         if (EI_cookie.isBouncyEnabled === false) {
        //             EI_cookie.isChatMinimized = !EI_cookie.isChatMinimized;
        //         }
        //     });
